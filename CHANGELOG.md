...
Added **Figure 14** (§4.3): grouped bar chart of between-farm vs within-farm ρ for sulfur's eight
strongest features (between-farm large, within-farm ≈0), generated by `adversarial_s.py` →
`output/plots/sulfur_between_within.png`.
